...
VALUES(MYMEMBERSEQ.NEXTVAL, 'admin', 'admin1234','이용준','서울시 양천구','010-0000-0000','admin@damin.com','Y','ADMIN');
...
INSERT INTO MYMEMBER
VALUES(MYMEMBERSEQ.NEXTVAL, 'user', 'user0001','이용준','서울시 양천구','010-0000-1234','user@user.com','Y','USER');
